    ...
    public class ConsoleMenu : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            if (active)
            {
                ...
                // Draw command string
                batch.DrawString(font, line + prefix + command,
                new Vector2(10.0f, height - (font.MeasureString(prefix).Y * 2.0f) - 4.0f), Color.White);
        ...
        private void ExecuteCommand()
        {
            ...
            {
                Game1.BGActive = !Game1.BGActive;
                log.Add(logPrefix + "Background: " + (Game1.BGActive ? "ON" : "OFF"));
            }
            else if (command.StartsWith("Toggle FPS", true, null) && command.EndsWith("Toggle FPS", true, null))
            {
                Game1.FPS.Enabled = !Game1.FPS.Enabled;
                Game1.FPS.Visible = !Game1.FPS.Visible;
                log.Add(logPrefix + "FPS: " + (Game1.FPS.Visible ? "ON" : "OFF"));
            }
